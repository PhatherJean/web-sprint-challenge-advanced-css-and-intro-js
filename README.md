...
ability to have the info on the page be translated or related in the way needed to be recieved by the user

2. Talk about 3 different things you can do to ensure your website is accessible. 
Make it mobile 
using proper sematic tags
use user friendly colors

3. How would you explain the concept of a variable to someone new to programming?
A variable is like a in place container so that the info can be added later

4. What is the purpose of using functions in code?
To take an input and create an output of the info provided in the input
